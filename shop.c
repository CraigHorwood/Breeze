...
const int MODE_PRICES[16] = {10, 10, 10, 20, 20, 20, 30, 30, 30, 50, 50, 50, 75, 90, 100, 0};
...
const char* MODE_NAMES[16] = {"HIGH GRAVITY", "HIGH SPEED", "CLOUDY MODE", "ONE HIT WONDER", "FREE FOR ALL", "MIRROR MODE", "ENDLESS RUNNER", "HEARTLESS MODE", "SAVE THIS PRECIOUS BIRD", "TIME TRIAL", "JUMP MODE", "SUPER HOT MODE", "LEGACY MODE", "SLIDING SCREEN", "SPINNING MODE", "THE GAUNTLET"};
...
void renderItem(int pos, int index)
{
	...
	if (!modesList)
	{
		...
		render(88.0f, yp + 28.0f, index == COLOUR_CYAN ? 360.0f : 120.0f, 0.0f, 120.0f, 96.0f);
